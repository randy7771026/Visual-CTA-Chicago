...
dir = {'Northbound': '[Northbound]', 'Southbound': '[Southbound]', 'Eastbound': '[Eastbound]', 'Westbound': '[Westbound]'}
...
#    print 'dir[rection]', dir[rection], 'god[go]', god[go]
    if god[go] == dir[rection]:
